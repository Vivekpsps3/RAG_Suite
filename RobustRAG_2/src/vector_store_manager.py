...
from . import VECTOR_STORE_DIR, DEFAULT_CHUNK_SIZE
...
class VectorStoreManager:
    ...
    def add_documents(
        ...
        batch_size: int = 5000  # Safe batch size well below ChromaDB's limit
    ) -> None:
    ...
    def retrieve(
        ...
        try:
            ...
            # Generate embedding for the query using our centralized model engine
