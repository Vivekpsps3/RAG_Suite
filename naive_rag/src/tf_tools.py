...
class LMAnswerModel:
    ...
    def generate(self, prompt: str, max_length: int = 100):
        ...
        # Configure OpenAI client to use LM Studio server
        # TODO: The 'openai.base_url' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(base_url="http://10.191.188.2:1234/v1")'
        # openai.base_url = "http://10.191.188.2:1234/v1"
